                        ...
                        <tbody>
                            <c:forEach items="${requestScope.complaints}" var="c" >
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-success btn-xs" data-complaintId="${c.id}" data-toggle="modal" data-target="#modalConfirmClose"><i class="fa fa-check"></i></button>
                                        <button class="btn btn-danger btn-xs" data-complaintId="${c.id}" data-toggle="modal" data-target="#modalConfirmReject"><i class="fa fa-times "></i></button>
                                    </td>
                                </tr>
                            </c:forEach>
                        </tbody>
