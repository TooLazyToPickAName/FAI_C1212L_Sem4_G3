function fnFormatDetails(oTable, nTr)
{
    ...
    $.getJSON("ajaxComplaintDetails", {
        ...
        sOut += '<tr><td>Date Register:</td><td>' + $.datepicker.formatDate("MM/dd yy", new Date(obj.dateCreated)) + '</td></tr>';
        
        var strDateClosed;
        if(obj.dateClosed) {
            strDateClosed = $.datepicker.formatDate("MM/dd yy", new Date(obj.dateClosed));
        } else {
